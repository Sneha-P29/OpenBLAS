      ...
      for (j = 0; j < (m >> 4); j++)
 {
  ...
  if (n & 2)
      ...
      if (m & 2)
	{
	  ...
	  for (l = 0; l < (temp << 1); l += 2)
	    {
	      v4sf_t rowA =
		{ (float)AO[l], (float)AO[l], (float)AO[l + 1],
		(float)AO[l + 1]
	      };
	      v4sf_t rowB =
		{ (float)BO[l], (float)BO[l + 1], (float)BO[l],
		(float)BO[l + 1]
	      };
	      t += rowA * rowB;
	    }
      ...
      if (m & 1)
	{
	  ...
	  for (l = 0; l < temp; l++)
	    {
	      v4sf_t rowA = { (float)AO[l], (float)AO[l], 0, 0 };
	      v4sf_t rowB =
		{ (float)BO[l << 1], (float)BO[(l << 1) + 1], 0,
		0
	      };
	      t += rowA * rowB;
	    }
  ...
  if (n & 1)
      ...
      if (m & 2)
	{
	  ...
	  for (l = 0; l < temp; l++)
	    {
	      v4sf_t rowB = { (float)BO[l], (float)BO[l], 0, 0 };
	      v4sf_t rowA =
		{ (float)AO[l << 1], (float)AO[(l << 1) + 1], 0,
		0
	      };
	      t += rowA * rowB;
	    }
