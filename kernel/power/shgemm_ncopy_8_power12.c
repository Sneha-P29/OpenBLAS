...
int CNAME(BLASLONG m, BLASLONG n, IFLOAT *a, BLASLONG lda, IFLOAT *b){
  ...
  vec_h16 vtemp05, vtemp06, vtemp07, vtemp08;
  vec_h16 vtemp09, vtemp10, vtemp11, vtemp12;
  vector char mask =
  ...
  if (j > 0){
	...
	do{
	  ...
	  vtemp02 = *(vec_h16 *)(aoffset2);
	  vtemp03 = *(vec_h16 *)(aoffset3);
	  vtemp04 = *(vec_h16 *)(aoffset4);
	  vtemp05 = *(vec_h16 *)(aoffset5);
	  vtemp06 = *(vec_h16 *)(aoffset6);
	  vtemp07 = *(vec_h16 *)(aoffset7);
	  vtemp08 = *(vec_h16 *)(aoffset8);
	  ...
	  *(vec_h16 *)(boffset + 0) = vec_xxpermdi(vtemp09, vtemp10, 0);
	  *(vec_h16 *)(boffset + 8) = vec_xxpermdi(vtemp11, vtemp12, 0);
	  *(vec_h16 *)(boffset + 16) = vec_xxpermdi(vtemp09, vtemp10, 3);
	  *(vec_h16 *)(boffset + 24) = vec_xxpermdi(vtemp11, vtemp12, 3);
	  ...
	  *(vec_h16 *)(boffset + 32) = vec_xxpermdi(vtemp09, vtemp10, 0);
	  *(vec_h16 *)(boffset + 40) = vec_xxpermdi(vtemp11, vtemp12, 0);
	  *(vec_h16 *)(boffset + 48) = vec_xxpermdi(vtemp09, vtemp10, 3);
	  *(vec_h16 *)(boffset + 56) = vec_xxpermdi(vtemp11, vtemp12, 3);
